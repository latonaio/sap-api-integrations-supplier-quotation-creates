...
func (sdc *SDC) ConvertToItem() *requests.Item {
	dataSupplierQuotation := sdc.SupplierQuotation
	data := sdc.SupplierQuotation.SupplierQuotationItem
	return &requests.Item{
			SupplierQuotation:              dataSupplierQuotation.SupplierQuotation,
